 ...
 */
class MailMagazineCustomerRepository extends EntityRepository implements UserProviderInterface
{
    public $app;
    ...
    // TODO plug-inでは使っていないので削除y
//     public function newCustomer()
//     {
//         $Customer = new Plugin\MailMagazine\Entity\MailMagazineCustomer();
...
//     }
    ...
    {
        return $class === 'Plugin\MailMagazine\Entity\MailMagazine';
    }
...
//                ->setParameter('birth_month', $searchData['birth_month']);
    ...
    public function getUniqueSecretKey($app)
    {
        ...
        $Customer = $app['eccube.plugin.mail_magazine.repository.mail_magazine_customer']->findBy(array(
            'secret_key' => $unique,
        ));
        if (count($Customer) == 0) {
            return $unique;
