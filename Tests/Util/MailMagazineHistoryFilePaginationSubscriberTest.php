...
class MailMagazineHistoryFilePaginationSubscriberTest extends AbstractMailMagazineTestCase
{
    ...
    public function test_1ページ目()
    {
        ...
        file_put_contents($file,
            '1,0_create_mail_magazine_history@example.com,name01_0 name02_0'.PHP_EOL.
        ...
        self::assertEquals(
            array(
                array('status' => '1', 'email' => '0_create_mail_magazine_history@example.com', 'name' => 'name01_0 name02_0'),
                array('status' => '1', 'email' => '1_create_mail_magazine_history@example.com', 'name' => 'name01_1 name02_1'),
                array('status' => '1', 'email' => '2_create_mail_magazine_history@example.com', 'name' => 'name01_2 name02_2'),
                array('status' => '1', 'email' => '3_create_mail_magazine_history@example.com', 'name' => 'name01_3 name02_3'),
            ),
            $actual->getItems()
        );
    }
    ...
    public function test_2ページ目()
    {
        ...
        self::assertEquals(
            array(
                array('status' => '1', 'email' => '4_create_mail_magazine_history@example.com', 'name' => 'name01_4 name02_4'),
                array('status' => '1', 'email' => '5_create_mail_magazine_history@example.com', 'name' => 'name01_5 name02_5'),
                array('status' => '1', 'email' => '6_create_mail_magazine_history@example.com', 'name' => 'name01_6 name02_6'),
                array('status' => '1', 'email' => '7_create_mail_magazine_history@example.com', 'name' => 'name01_7 name02_7'),
            ),
            $actual->getItems()
        );
    }
    ...
    public function test_最終ページ()
    {
        ...
        self::assertEquals(
            array(
                array('status' => '1', 'email' => '8_create_mail_magazine_history@example.com', 'name' => 'name01_8 name02_8'),
                array('status' => '1', 'email' => '9_create_mail_magazine_history@example.com', 'name' => 'name01_9 name02_9'),
            ),
            $actual->getItems()
        );
    }
